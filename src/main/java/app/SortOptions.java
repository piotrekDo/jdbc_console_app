...
public class SortOptions {
    ...
    public SortOptions(ConsolePrinter consolePrinter, InputCollector inputCollector, Map<String, String> tableDetails, String tableName) {
    ...
    Sort load(String sortyBy, boolean isDescending) {
        List<String> strings = tableDetails.keySet().stream().toList();
